...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReportCommentView'
        db.create_table('dashboard_reportcommentview', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('report_comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.ReportComment'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('dashboard', ['ReportCommentView'])

        # Adding unique constraint on 'ReportCommentView', fields ['user', 'report_comment']
        db.create_unique('dashboard_reportcommentview', ['user_id', 'report_comment_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ReportCommentView', fields ['user', 'report_comment']
        db.delete_unique('dashboard_reportcommentview', ['user_id', 'report_comment_id'])

        # Deleting model 'ReportCommentView'
        db.delete_table('dashboard_reportcommentview')
