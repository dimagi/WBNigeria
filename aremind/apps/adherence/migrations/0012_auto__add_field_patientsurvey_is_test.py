...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PatientSurvey.is_test'
        db.add_column('adherence_patientsurvey', 'is_test', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PatientSurvey.is_test'
        db.delete_column('adherence_patientsurvey', 'is_test')
    ...
    models = {
        'adherence.entry': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'c0742116ca6842dab9251b3f61807083'", 'max_length': '255'})
        },
        'adherence.entryseen': {
        ...
        'patients.patient': {
            ...
            'date_enrolled': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 6, 2)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
