...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FadamaReport.for_this_site'
        db.add_column('dashboard_fadamareport', 'for_this_site',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'FadamaReport.site'
        db.alter_column('dashboard_fadamareport', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location']))
        # Adding field 'PBFReport.for_this_site'
        db.add_column('dashboard_pbfreport', 'for_this_site',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'PBFReport.site'
        db.alter_column('dashboard_pbfreport', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location']))

    def backwards(self, orm):
        # Deleting field 'FadamaReport.for_this_site'
        db.delete_column('dashboard_fadamareport', 'for_this_site')


        # Changing field 'FadamaReport.site'
        db.alter_column('dashboard_fadamareport', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'], null=True))
        # Deleting field 'PBFReport.for_this_site'
        db.delete_column('dashboard_pbfreport', 'for_this_site')


        # Changing field 'PBFReport.site'
        db.alter_column('dashboard_pbfreport', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'], null=True))
