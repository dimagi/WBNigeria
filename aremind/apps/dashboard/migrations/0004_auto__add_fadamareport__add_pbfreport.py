...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FadamaReport'
        db.create_table('dashboard_fadamareport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('reporter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Connection'])),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'])),
            ('freeform', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ...
        db.send_create_signal('dashboard', ['FadamaReport'])

        # Adding model 'PBFReport'
        db.create_table('dashboard_pbfreport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('reporter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Connection'])),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'])),
        ...
        db.send_create_signal('dashboard', ['PBFReport'])


    def backwards(self, orm):
        # Deleting model 'FadamaReport'
        db.delete_table('dashboard_fadamareport')

        # Deleting model 'PBFReport'
        db.delete_table('dashboard_pbfreport')
    ...
    models = {
        ...
        'dashboard.reportcomment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'report_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
