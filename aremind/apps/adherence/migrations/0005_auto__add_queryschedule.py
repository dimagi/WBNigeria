...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'QuerySchedule'
        db.create_table('adherence_queryschedule', (
        ...
        db.send_create_signal('adherence', ['QuerySchedule'])

        # Adding M2M table for field recipients on 'QuerySchedule'
        db.create_table('adherence_queryschedule_recipients', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('queryschedule', models.ForeignKey(orm['adherence.queryschedule'], null=False)),
            ('group', models.ForeignKey(orm['groups.group'], null=False))
        ))
        db.create_unique('adherence_queryschedule_recipients', ['queryschedule_id', 'group_id'])


    def backwards(self, orm):
        
        # Deleting model 'QuerySchedule'
        db.delete_table('adherence_queryschedule')

        # Removing M2M table for field recipients on 'QuerySchedule'
        db.delete_table('adherence_queryschedule_recipients')
    ...
    models = {
        'adherence.entry': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'cd17eaf124d645aab9e1e7d5f5a4487f'", 'max_length': '255'})
        },
        'adherence.entryseen': {
        ...
        'patients.patient': {
            ...
            'date_enrolled': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 5, 24)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
