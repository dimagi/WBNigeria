...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportComment.author_user'
        db.add_column('dashboard_reportcomment', 'author_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportComment.author_user'
        db.delete_column('dashboard_reportcomment', 'author_user_id')
    ...
    models = {
        ...
        'dashboard.reportcomment': {
            ...
            'author_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
