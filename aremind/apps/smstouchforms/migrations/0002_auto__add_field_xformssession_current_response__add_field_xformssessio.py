...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XFormsSession.ended'
        db.add_column('smstouchforms_xformssession', 'ended', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'XFormsSession.ended'
        db.delete_column('smstouchforms_xformssession', 'ended')
