...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WBUser.survey_question_ans'
        db.add_column('wbn_registration_wbuser', 'survey_question_ans', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'WBUser.want_more_surveys'
        db.add_column('wbn_registration_wbuser', 'want_more_surveys', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WBUser.survey_question_ans'
        db.delete_column('wbn_registration_wbuser', 'survey_question_ans')

        # Deleting field 'WBUser.want_more_surveys'
        db.delete_column('wbn_registration_wbuser', 'want_more_surveys')
