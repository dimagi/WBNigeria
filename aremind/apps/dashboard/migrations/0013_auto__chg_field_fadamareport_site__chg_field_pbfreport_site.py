...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'FadamaReport.site'
        raise RuntimeError("Cannot reverse this migration. 'FadamaReport.site' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'PBFReport.site'
        raise RuntimeError("Cannot reverse this migration. 'PBFReport.site' and its values cannot be restored.")
    ...
    models = {
        ...
        'dashboard.fadamareport': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['locations.Location']", 'null': 'True', 'blank': 'True'}),
