...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FadamaReport.satisfied'
        db.alter_column('dashboard_fadamareport', 'satisfied', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'PBFReport.satisfied'
        db.alter_column('dashboard_pbfreport', 'satisfied', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'FadamaReport.satisfied'
        db.alter_column('dashboard_fadamareport', 'satisfied', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'PBFReport.satisfied'
        db.alter_column('dashboard_pbfreport', 'satisfied', self.gf('django.db.models.fields.BooleanField')())
