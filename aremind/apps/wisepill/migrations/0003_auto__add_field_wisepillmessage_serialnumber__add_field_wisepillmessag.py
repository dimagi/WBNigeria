...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WisepillMessage.serialnumber'
        db.add_column('wisepill_wisepillmessage', 'serialnumber', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'WisepillMessage.signalstrength'
        db.add_column('wisepill_wisepillmessage', 'signalstrength', self.gf('django.db.models.fields.IntegerField')(default=-1, blank=True), keep_default=False)

        # Adding field 'WisepillMessage.batterystrength'
        db.add_column('wisepill_wisepillmessage', 'batterystrength', self.gf('django.db.models.fields.IntegerField')(default=-1, blank=True), keep_default=False)

        # Adding field 'WisepillMessage.puffcount'
        db.add_column('wisepill_wisepillmessage', 'puffcount', self.gf('django.db.models.fields.IntegerField')(default=-1, blank=True), keep_default=False)

        # Adding field 'WisepillMessage.ussdresponse'
        db.add_column('wisepill_wisepillmessage', 'ussdresponse', self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True), keep_default=False)

        # Adding field 'WisepillMessage.medicationcompartment'
        db.add_column('wisepill_wisepillmessage', 'medicationcompartment', self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True), keep_default=False)

        # Adding field 'WisepillMessage.ce'
        db.add_column('wisepill_wisepillmessage', 'ce', self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WisepillMessage.serialnumber'
        db.delete_column('wisepill_wisepillmessage', 'serialnumber')

        # Deleting field 'WisepillMessage.signalstrength'
        db.delete_column('wisepill_wisepillmessage', 'signalstrength')

        # Deleting field 'WisepillMessage.batterystrength'
        db.delete_column('wisepill_wisepillmessage', 'batterystrength')

        # Deleting field 'WisepillMessage.puffcount'
        db.delete_column('wisepill_wisepillmessage', 'puffcount')

        # Deleting field 'WisepillMessage.ussdresponse'
        db.delete_column('wisepill_wisepillmessage', 'ussdresponse')

        # Deleting field 'WisepillMessage.medicationcompartment'
        db.delete_column('wisepill_wisepillmessage', 'medicationcompartment')

        # Deleting field 'WisepillMessage.ce'
        db.delete_column('wisepill_wisepillmessage', 'ce')
    ...
    models = {
        'patients.patient': {
            ...
            'date_enrolled': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 4)'}),
