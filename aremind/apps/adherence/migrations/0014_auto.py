...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field patients on 'QuerySchedule'
        db.create_table('adherence_queryschedule_patients', (
        ...
        db.create_unique('adherence_queryschedule_patients', ['queryschedule_id', 'patient_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field patients on 'QuerySchedule'
        db.delete_table('adherence_queryschedule_patients')
