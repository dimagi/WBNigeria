...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PatientSurvey.created_timestamp'
        db.delete_column('adherence_patientsurvey', 'created_timestamp')

        # Deleting field 'PatientSurvey.started_timestamp'
        db.delete_column('adherence_patientsurvey', 'started_timestamp')

        # Deleting field 'PatientSurvey.completed_timestamp'
        db.delete_column('adherence_patientsurvey', 'completed_timestamp')

        # Adding field 'PatientSurvey.last_modified'
        db.add_column('adherence_patientsurvey', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 5, 26, 10, 19, 8, 993355), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'PatientSurvey.created_timestamp'
        db.add_column('adherence_patientsurvey', 'created_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 5, 26, 10, 18, 50, 543346), blank=True), keep_default=False)

        # Adding field 'PatientSurvey.started_timestamp'
        db.add_column('adherence_patientsurvey', 'started_timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'PatientSurvey.completed_timestamp'
        db.add_column('adherence_patientsurvey', 'completed_timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Deleting field 'PatientSurvey.last_modified'
        db.delete_column('adherence_patientsurvey', 'last_modified')
    ...
    models = {
        'adherence.entry': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'505e220f185e46d0b9409ce42ff90a27'", 'max_length': '255'})
        },
        'adherence.entryseen': {
