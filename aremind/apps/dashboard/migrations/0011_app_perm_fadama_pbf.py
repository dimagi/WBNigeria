...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(
            model='pbfreport', app_label='dashboard')
        perm, created = orm['auth.permission'].objects.get_or_create(
            content_type=ct, codename='pbf_view', defaults=dict(name=u'View PBF reports'))

        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(
            model='fadamareport', app_label='dashboard')
        perm, created = orm['auth.permission'].objects.get_or_create(
            content_type=ct, codename='fadama_view', defaults=dict(name=u'View Fadama reports'))
    ...
    complete_apps = ['contenttypes', 'auth', 'dashboard']
    symmetrical = True
