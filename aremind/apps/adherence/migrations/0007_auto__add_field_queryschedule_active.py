...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'QuerySchedule.active'
        db.add_column('adherence_queryschedule', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'QuerySchedule.active'
        db.delete_column('adherence_queryschedule', 'active')
    ...
    models = {
        'adherence.entry': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'264272c7031242048ebe9f86e3add7c9'", 'max_length': '255'})
        },
        'adherence.entryseen': {
