...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WBUser.contact'
        db.alter_column('wbn_registration_wbuser', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Connection']))


    def backwards(self, orm):
        
        # Changing field 'WBUser.contact'
        db.alter_column('wbn_registration_wbuser', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Contact']))
    ...
    models = {
        ...
        'wbn_registration.wbuser': {
            ...
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rapidsms.Connection']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
