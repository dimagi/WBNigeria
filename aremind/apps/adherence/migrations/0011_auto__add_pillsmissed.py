...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PillsMissed'
        db.create_table('adherence_pillsmissed', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patients.Patient'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('num_missed', self.gf('django.db.models.fields.IntegerField')()),
            ('source', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('adherence', ['PillsMissed'])


    def backwards(self, orm):
        
        # Deleting model 'PillsMissed'
        db.delete_table('adherence_pillsmissed')
    ...
    models = {
        'adherence.entry': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'6f994b238f714e25953a5acbf1f872a0'", 'max_length': '255'})
        },
        'adherence.entryseen': {
