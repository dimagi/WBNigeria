...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("locations", "0002_auto__add_field_location_name__add_field_location_slug"),
    )
    ...
    def forwards(self, orm):
        ...
        db.add_column('rapidsms_contact', 'location',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('rapidsms_contact', 'location_id')
