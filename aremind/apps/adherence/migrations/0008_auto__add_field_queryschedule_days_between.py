...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'QuerySchedule.days_between'
        db.add_column('adherence_queryschedule', 'days_between', self.gf('django.db.models.fields.IntegerField')(default=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'QuerySchedule.days_between'
        db.delete_column('adherence_queryschedule', 'days_between')
    ...
    models = {
        'adherence.entry': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'6a82805d11de48e195a8ee6eecf8ab8a'", 'max_length': '255'})
        },
        'adherence.entryseen': {
