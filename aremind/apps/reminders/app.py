...
def scheduler_callback(router):
    ...
    """
    app = router.get_app("aremind.apps.reminders")
    app.cronjob()
...
#    cron_schedule = {'minutes': ['0'], 'hours': ['10']}
    ...
    cron_callback = 'aremind.apps.reminders.app.scheduler_callback'
    ...
    def start(self):
        ...
        info = {
            'callback': 'aremind.apps.reminders.app.daily_email_callback',
            'hours': [12],
            'minutes': [0],
