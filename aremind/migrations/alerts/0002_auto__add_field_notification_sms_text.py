...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.sms_text'
        db.add_column('alerts_notification', 'sms_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.sms_text'
        db.delete_column('alerts_notification', 'sms_text')
    ...
    models = {
        'alerts.notification': {
            ...
            'sms_text': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
