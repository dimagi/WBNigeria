...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.percent_max'
        db.add_column('adherence_entry', 'percent_max', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Entry.percent_min'
        db.add_column('adherence_entry', 'percent_min', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.percent_max'
        db.delete_column('adherence_entry', 'percent_max')

        # Deleting field 'Entry.percent_min'
        db.delete_column('adherence_entry', 'percent_min')
    ...
    models = {
        'adherence.entry': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'6ae3c00f9e714dcc94a2e318098e68b7'", 'max_length': '255'})
        },
        'adherence.entryseen': {
        ...
        'patients.patient': {
            ...
            'date_enrolled': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 6, 20)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
