...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field contact_tags on 'ReportComment'
        db.create_table('dashboard_reportcomment_contact_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('reportcomment', models.ForeignKey(orm['dashboard.reportcomment'], null=False)),
            ('contact', models.ForeignKey(orm['rapidsms.contact'], null=False))
        ))
        db.create_unique('dashboard_reportcomment_contact_tags', ['reportcomment_id', 'contact_id'])


    def backwards(self, orm):
        # Removing M2M table for field contact_tags on 'ReportComment'
        db.delete_table('dashboard_reportcomment_contact_tags')
