...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'QuerySchedule.last_run'
        db.add_column('adherence_queryschedule', 'last_run', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'QuerySchedule.last_run'
        db.delete_column('adherence_queryschedule', 'last_run')
    ...
    models = {
        'adherence.entry': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'c349a4b776e1468a8bfd48ebf8003c13'", 'max_length': '255'})
        },
        'adherence.entryseen': {
