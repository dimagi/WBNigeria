...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WBUser'
        db.create_table('wbn_registration_wbuser', (
            ...
            ('location_code', self.gf('django.db.models.fields.CharField')(max_length=4)),
        ))
        db.send_create_signal('wbn_registration', ['WBUser'])


    def backwards(self, orm):
        
        # Deleting model 'WBUser'
        db.delete_table('wbn_registration_wbuser')
