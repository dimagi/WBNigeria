...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('dashboard_reportcomment', 'report_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.FadamaReport'], null=True, blank=True))
        db.rename_column('dashboard_reportcomment', 'report_id', 'fadama_report_id')

        db.add_column('dashboard_reportcomment', 'pbf_report',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.PBFReport'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ReportComment.report'
        raise RuntimeError("Cannot reverse this migration. 'ReportComment.report' and its values cannot be restored.")
